...
$(function(){$(window).scroll(function(){var o=$(this).scrollTop();$(".parallax-bg").css("bottom",-.5*o+"px")}),$('a[data-target^="anchor"]').bind("click.smoothscroll",function(){var o=$(this).attr("href"),t=$(o).offset().top;return $("body, html").animate({scrollTop:t},1500),!1}),$(".slider-main").owlCarousel({loop:!0,nav:!0,items:1,mouseDrag:!1,smartSpeed:1e3,dots:!1,navText:['<img src="img/l-arrow-w.svg" alt="arrow" />','<img src="img/r-arrow-w.svg" alt="arrow" />']}),$(".slider-sertificates").owlCarousel({loop:!0,nav:!0,items:4,mouseDrag:!1,smartSpeed:1e3,dots:!1,navText:['<img src="img/l-arrow.svg" alt="arrow" />','<img src="img/r-arrow.svg" alt="arrow" />']}),$(".clients-slider").owlCarousel({loop:!0,nav:!0,items:5,margin:30,mouseDrag:!1,smartSpeed:1e3,dots:!1,navText:['<img src="img/l-arrow.svg" alt="arrow" />','<img src="img/r-arrow.svg" alt="arrow" />']}),$("#showHideContent").click(function(){return $("#content").is(":hidden")?$("#content").show("slow"):$("#content").hide("slow"),!1}),$(".button-hide").click(function(){var o=$(this);o.toggleClass("button-hide"),o.hasClass("button-hide")?(o.text("Показать больше"),o.css("margin-top","150px")):(o.text("Скрыть"),o.css("margin-top","50px"))}),$(".popup-sertificates, .popup-toros-img").magnificPopup({type:"image",mainClass:"my-mfp-zoom-in",removalDelay:300,fixedContentPos:!1}),$(".top-mnu a").mPageScroll2id(),$(".top").click(function(){return $("html, body").animate({scrollTop:0},"slow"),!1}),$(".slide-content, a[href='#callback']").magnificPopup({type:"inline",mainClass:"mfp-form"}),$(".form").submit(function(){var o=$(this);return $.ajax({type:"POST",url:"mail.php",data:o.serialize()}).done(function(){alert("Спасибо за заявку!"),setTimeout(function(){$.magnificPopup.close(),o.trigger("reset")},1e3)}),!1})});